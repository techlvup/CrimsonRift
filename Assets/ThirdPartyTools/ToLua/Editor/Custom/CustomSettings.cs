...
{
    public static string warpSaveDir = Application.dataPath + "/ThirdPartyTools/ToLua/Source/Generate/";
    public static string toolSaveDir = Application.dataPath + "/ThirdPartyTools/ToLua/Source/";
    public static string toluaBaseType = Application.dataPath + "/ThirdPartyTools/ToLua/BaseType/";
    public static string baseLuaDir = DataUtilityManager.m_localRootPath + "Lua/ToLua/";
    public static string injectionFilesPath = Application.dataPath + "/ThirdPartyTools/ToLua/Injection/";
